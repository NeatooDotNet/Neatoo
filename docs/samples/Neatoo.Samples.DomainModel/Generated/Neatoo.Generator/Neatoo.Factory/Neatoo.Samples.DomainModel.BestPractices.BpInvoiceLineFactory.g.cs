...
namespace Neatoo.Samples.DomainModel.BestPractices
{
    ...
    internal class BpInvoiceLineFactory : FactoryBase<IBpInvoiceLine>, IBpInvoiceLineFactory
    {
        ...
        public virtual Task<IBpInvoiceLine> LocalSave(IBpInvoiceLine target, long invoiceId, CancellationToken cancellationToken = default)
        {
            if (target.IsDeleted)
            {
            ...
            {
                return LocalInsert(target, invoiceId, cancellationToken);
            }
            else
            {
                throw new NotImplementedException();
