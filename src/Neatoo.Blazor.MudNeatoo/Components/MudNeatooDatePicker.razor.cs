...
/// <summary>
/// A MudBlazor date picker component that binds to an IEntityProperty
/// and displays Neatoo validation messages.
/// </summary>
public partial class MudNeatooDatePicker : ComponentBase, IDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// The margin around the date picker.
    /// </summary>
    [Parameter]
    ...
    private DateTime? TypedValue => (DateTime?)this.EntityProperty.Value;
    ...
    private async Task<IEnumerable<string>> ValidateAsync(DateTime? value)
    {
