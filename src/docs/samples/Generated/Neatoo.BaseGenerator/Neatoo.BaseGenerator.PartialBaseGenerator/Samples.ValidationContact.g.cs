...
namespace Samples
{
    public partial class ValidationContact
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            return sourceExpression switch
            {
                ...
                @"MaxLengthAttribute_Name" => 2u,
                @"PhoneAttribute_PhoneNumber" => 3u,
                @"RangeAttribute_Age" => 4u,
                @"RegularExpressionAttribute_ZipCode" => 5u,
                @"RequiredAttribute_Name" => 6u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.ValidationContact> factory)
        {
