...
namespace Samples
{
    public partial class RulesManualEntity
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            ...
            {
                @"e => e.Value > 0 ? """" : ""Value must be positive""" => 1u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RulesManualEntity> factory)
        {
