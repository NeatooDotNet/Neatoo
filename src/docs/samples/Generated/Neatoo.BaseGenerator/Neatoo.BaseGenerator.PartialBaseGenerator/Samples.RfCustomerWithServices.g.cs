...
namespace Samples
{
    public partial class RfCustomerWithServices
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RfCustomerWithServices> factory)
        {
