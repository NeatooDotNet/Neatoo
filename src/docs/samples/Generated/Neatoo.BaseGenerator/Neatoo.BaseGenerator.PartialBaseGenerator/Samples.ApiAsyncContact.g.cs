...
namespace Samples
{
    public partial class ApiAsyncContact
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            ...
            {
                @"async contact => { if (!string.IsNullOrEmpty(contact.ZipCode)) { contact.TaxRate = await pricingService.GetTaxRateAsync(contact.ZipCode); } }" => 1u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.ApiAsyncContact> factory)
        {
