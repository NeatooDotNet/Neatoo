...
namespace Samples
{
    public partial class ValidationProduct
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            ...
            {
                @"p => !string.IsNullOrEmpty(p.Name) ? """" : ""Name is required""" => 1u,
                @"p => p.Price >= 0 ? """" : ""Price cannot be negative""" => 2u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.ValidationProduct> factory)
        {
