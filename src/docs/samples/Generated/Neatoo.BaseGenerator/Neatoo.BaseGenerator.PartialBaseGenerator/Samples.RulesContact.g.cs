...
namespace Samples
{
    public partial class RulesContact
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            ...
            {
                @"contact => contact.FullName = $""{contact.FirstName} {contact.LastName}""" => 1u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RulesContact> factory)
        {
