...
namespace Samples
{
    public partial class ApiGeneratedCustomer
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.ApiGeneratedCustomer> factory)
        {
