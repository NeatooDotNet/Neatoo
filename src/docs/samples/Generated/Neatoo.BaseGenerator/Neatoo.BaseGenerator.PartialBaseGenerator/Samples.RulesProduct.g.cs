...
namespace Samples
{
    public partial class RulesProduct
    {
        ...
        protected override uint GetRuleId(string sourceExpression)
        {
            ...
            {
                @"async product => { product.TaxRate = await pricingService.GetTaxRateAsync(product.ZipCode); }" => 1u,
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RulesProduct> factory)
        {
