...
namespace Samples
{
    public partial class RfCustomerMultiFetch
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RfCustomerMultiFetch> factory)
        {
