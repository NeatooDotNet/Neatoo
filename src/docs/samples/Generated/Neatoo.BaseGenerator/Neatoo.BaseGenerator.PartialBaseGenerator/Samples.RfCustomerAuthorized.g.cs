...
namespace Samples
{
    public partial class RfCustomerAuthorized
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Samples.RfCustomerAuthorized> factory)
        {
