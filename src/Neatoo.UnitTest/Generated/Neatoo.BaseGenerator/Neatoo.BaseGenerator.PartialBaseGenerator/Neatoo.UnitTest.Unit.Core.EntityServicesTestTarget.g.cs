...
{
    public partial class EntityServicesTestTarget
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Neatoo.UnitTest.Unit.Core.EntityServicesTestTarget> factory)
        {
