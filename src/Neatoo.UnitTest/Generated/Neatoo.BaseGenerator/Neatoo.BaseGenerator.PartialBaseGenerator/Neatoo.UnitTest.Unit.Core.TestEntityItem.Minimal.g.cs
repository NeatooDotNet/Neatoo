...
{
    private partial class TestEntityItem
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Neatoo.UnitTest.Unit.Core.EntityListBaseTests.TestEntityItem> factory)
        {
