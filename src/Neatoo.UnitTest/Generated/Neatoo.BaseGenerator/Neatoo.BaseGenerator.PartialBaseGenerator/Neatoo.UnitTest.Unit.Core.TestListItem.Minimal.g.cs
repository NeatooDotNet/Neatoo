...
{
    private partial class TestListItem
    {
        ...
        /// </summary>
        protected override void InitializePropertyBackingFields(IPropertyFactory<Neatoo.UnitTest.Unit.Core.ListBaseTests.TestListItem> factory)
        {
